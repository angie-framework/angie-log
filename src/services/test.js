...
var $LogProvider = (function () {
    ...
    function $LogProvider() {
        var outfile = arguments[0] === undefined ? DEFAULT_LOG_FILE : arguments[0];
        var timestamp = arguments[1] === undefined ? true : arguments[1];
        var level = arguments[2] === undefined ? 'DEBUG' : arguments[2];
        var silent = arguments[3] === undefined ? false : arguments[3];
    ...
    _createClass($LogProvider, [{
        ...
        value: function $setOutfile() {
            var o = arguments[0] === undefined ? DEFAULT_LOG_FILE : arguments[0];
        ...
        value: function $setTimestamp() {
            var t = arguments[0] === undefined ? true : arguments[0];
        ...
        value: function $setSilent() {
            var s = arguments[0] === undefined ? false : arguments[0];
